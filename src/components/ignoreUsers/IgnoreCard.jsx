          ...
          <div>
            ...
            <div className='display-only-mobile'>
              <div className='ignorecase-text'>
                <p className='age'>{ignoreUserText.Age} : </p><p className='age'>{getAge(user.time_of_birth)}</p>
              </div>
              <div className='ignorecase-text'>
                <p className='age'>{ignoreUserText.Religion} :</p><p className='age'>{user.religion.religion_name}</p>
              </div>
            </div>
            <button className='ignorecase-button' style={{ backgroundColor: buttonBackgroundColor, color: viewButtonColor }}>
              <p style={{ color: viewButtonColor, textDecoration: 'none' }}>{ignoreUserText.ViewProfileBtn}</p>
            </button>
          </div>
        </div>
      </Card>
