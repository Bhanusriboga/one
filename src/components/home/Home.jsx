    ...
    <div className="home-page-div d-flex flex-column justify-content-between align-items-center w-100 ">
      <nav
        ...
        <div className="container-fluid">
          ...
          <div
            className={`collapse navbar-collapse ${burger ? "show" : ""}`}
            id="navbarNav">
      ...
      <div className="content11 d-flex flex-column justify-content-center align-items-center">
        ...
        <div
          className="footer-1 mt-5 d-flex flex-column align-items-center justify-content-evenly"
          id="footer"
          ref={bottomRef}>
          <div className="first-footer d-flex flex-column justify-content-evenly align-items-center">
            <div className="d-flex justify-content-center align-items-center">
              ...
              <h4 className="footer-head">
                Let&apos;s write our own love story together : Download Our App
                For Any Queries
              </h4>
              <img src={chakra} className="chakra" />
            </div>
            <p className="footer-para">
              Our platform is dedicated to helping you find a lifelong partner
              who shares your values, dreams, and aspirations.
            </p>
