      ...
      <Card
        ...
        <div className="user-card-icons-container">
          <img
            ...
            data-testid="usercard-ignoreicon"
            onClick={onMoveToIgnoreList}
          />
          <AiFillHeart
            className="usercard-hearticon"
            style={{ color: "white" }}
            data-testid="usercard-hearticon"
            onClick={removeUserFromShortList}
          />
        </div>
        <div className="shortlist-mobile">
          ...
          <div>
            ...
            <button
              className="usercard-button-mobile"
              style={{
              ...
              <Link
                to={`/user/${user.id}`}
                style={{ color: viewButtonColor, textDecoration: "none" }}>
                View Profile
              </Link>
            </button>
            <div className="usercard-only-mobileview">
              <div className="usercard-text">
                <p className="user-age">{ignoreUserText.Age} : </p>
                <p className="user-age">{getAge(user.time_of_birth)}</p>
              </div>
              <div className="usercard-text">
                <p className="user-age">{ignoreUserText.Religion} :</p>
                <p className="user-age">{user.religion.religion_name}</p>
              </div>
            </div>
            <button
